...
// NOTE: The original Animate UI sidebar depends on Highlight primitives.
// If they weren't installed, fall back to no-op wrappers so you can still
// render and test the sidebar.
